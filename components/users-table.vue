...
export default {
  ...
  methods: {
    ...
    async deleteItemConfirm () {
      ...
      await axios.delete('http://pzi022022.studenti.sumit.sum.ba/backend/api/admin/users/' + this.items[this.editedIndex].email, config).then(response => {
        console.log(response);
    ...
    async save () {
      ...
      await axios.post('http://pzi022022.studenti.sumit.sum.ba/backend/api/register', this.editedItem, config).then(response => {
        console.log(response);
    ...
    async update () {
      ...
      await axios.put('http://pzi022022.studenti.sumit.sum.ba/backend/api/admin/users/' + this.editedEmail, this.editedItem, config).then(response => {
        console.log(response);
        if (this.editedIndex > -1) {
          Object.assign(this.items[this.editedIndex], this.editedItem)
        } else {
